# DevClub - Gerador de Sites com IA
...
- **JavaScript**: Interatividade e integração com IA
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/IuriMontarroyos/declub-estudo-gera-oIA.git
   cd declub-estudo-gera-oIA
   ```
...
3. Configure sua chave da API Groq no arquivo `scripts.js`:
   ```javascript
   const API_KEY = "SUA_CHAVE_REAL_AQUI"
   ```

4. Descreva seu negócio no campo de texto e clique em "Gerar"!
...
├── scripts.js          # Lógica JavaScript e integração com IA
...
- [ ] **Análise de Performance**: Métricas de carregamento e otimização

### Melhorias Técnicas:
- [ ] **TypeScript**: Migrar para TypeScript para melhor manutenção
- [ ] **Testes Automatizados**: Framework de testes (Jest, Cypress)
